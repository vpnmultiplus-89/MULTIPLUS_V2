...
data_ip="https://raw.githubusercontent.com/vpnmultiplus-89/ip_vps/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/@VPNMULTIPLUSSTORE"
...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                       VPNMULTIPLUS STORE               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo ""
...
url_izin="https://raw.githubusercontent.com/vpnmultiplus-89/ip_vps/main/ip"
rm -f /usr/bin/user
...
clear
REPO="https://raw.githubusercontent.com/vpnmultiplus-89/MULTIPLUS_V2/main/"
start=$(date +%s)
secs_to_human() {
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/VPNMULTIPLUSSTORE"},{"text":"Contack","url":"wa.me/+6282164649858"}]]}'
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m                 ----[ VPNMULTIPLUS PROJECT ]----                \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Telegram : @VPNMULTIPLUSSTORE \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
